...
targetblotse<-function(lab,interval1,interval2,tabular=FALSE){
  ...
  cdf <- do.call(rbind,
    ...
    g<-ggplot(data=subset(aa,Lab==lab))+
      ...
      geom_segment(aes(x=pointdata["Liver"][1,],xend=expectation["mix1"][2,],y=pointdata["Liver"][2,],yend=expectation["mix2"][2,],col="Liver"), linetype = "dotted", color="orange")+
      geom_segment(aes(x=pointdata["Brain"][1,],xend=expectation["mix1"][1,],y=pointdata["Brain"][2,],yend=expectation["mix2"][1,],col="Brain"), linetype = "dotted", color="blue")+
      geom_segment(aes(x=pointdata["Placenta"][1,],xend=expectation["mix1"][3,],y=pointdata["Placenta"][2,],yend=expectation["mix2"][3,],col="Placenta"), linetype = "dotted", color="red")
    return(g)
}
